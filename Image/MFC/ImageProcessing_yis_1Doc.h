...
// ImageProcessing_yis_1Doc.h: CImageProcessingyis1Doc 클래스의 인터페이스
//
...
class CImageProcessingyis1Doc : public CDocument
{
protected: // serialization에서만 만들어집니다.
	CImageProcessingyis1Doc() noexcept;
	DECLARE_DYNCREATE(CImageProcessingyis1Doc)
...
// 구현입니다.
public:
	virtual ~CImageProcessingyis1Doc();
#ifdef _DEBUG
